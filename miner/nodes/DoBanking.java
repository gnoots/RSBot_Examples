        ...
        if (banker != null) {
            ...
            if (!Methods.isOnScreen((banker))) {
                ...
                if (Calculations.distanceTo(banker.getLocation()) < 10) {
                    ...
                    */
                    if (Bank.open()) {
                        // Add the count of the ores in our inventory to the total amount of banked ores.
                        Mining.setOresBanked(Inventory.getCount(Mining.getInvOresIdsAsArray()));
